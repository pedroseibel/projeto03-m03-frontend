    ...
    <div className="container flex-grow-1">
      <div className="row">
        <div className="col">
          ...
          <h2 className="text-center">{vaga.especie}</h2>
          <h4 className="text-center">{vaga.continente}</h4>
          <h5 className="text-center">{vaga.distribuicaoGeografica}</h5>
          <h5 className="text-center">{vaga.habitat}</h5>
          <h5 className="text-center">{vaga.estadoConservacao}</h5>
